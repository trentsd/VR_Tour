...
namespace VRStandardAssets.Utils
{
    ...
    public class VRCameraFade : MonoBehaviour
    {
        ...
        public void FadeOut(float duration, bool fadeAudio)
        {
            ...
            // Fade out the audio over the same duration. *************NOT USING SOUND*******************
        ...
        public void FadeIn(float duration, bool fadeAudio)
        {
            ...
            // Fade in the audio over the same duration. *************NOT USING SOUND*******************
        ...
        {
            // Fade out the audio over the default duration. *************NOT USING SOUND*******************
            //if (m_FadedSnapshot && fadeAudio)
        ...
        {
            // Fade out the audio over the given duration. *************NOT USING SOUND*******************
            //if(m_FadedSnapshot && fadeAudio)
            //m_FadedSnapshot.TransitionTo (duration);
        ...
        {
            // Fade in the audio over the default duration. *************NOT USING SOUND*******************
            //if(m_DefaultSnapshot && fadeAudio)
        ...
        {
            // Fade in the audio over the given duration. *************NOT USING SOUND*******************
            //if (m_DefaultSnapshot && fadeAudio)
                //m_DefaultSnapshot.TransitionTo (duration);
